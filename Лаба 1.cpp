...
int main() {
	...
	//1
	std::cout << "1. Ледяев Тимофей Сергеевич, 221-353 " << std::endl;
	...
	//3
	std::cout << "3. Введите число: " << std::endl;
	
	long long g;
	
	std::cin >> g;
	std::cout << "В двоичном виде: " << std::bitset<std::numeric_limits<int>::digits>(g) << std::endl;
	std::cout << "В шестнадцатиречном виде: " << std::hex << g << std::endl;
	std::cout << "bool " << (bool)g << std::endl;
	std::cout << "double " << (double)g << std::endl;
	std::cout << "char " << (char)g << std::endl;

	//4
	std::cout << "4. a*x=b. Введите значения a и b: ";
	...
	//5
	std::cout << "5.Введите координаты отрезка на прямой: ";
	...
	std::cin >> d >> c;
	e = (d + c) / 2.;
	std::cout << "Центр координат находится в точке: " << e << "." << std::endl;
